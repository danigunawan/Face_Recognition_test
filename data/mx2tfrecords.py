...
def parse_args():
    ...
    parser.add_argument('--bin_path', default='D:/Project/face/insightface-master/datasets/mingxing.rec', type=str,
                        help='path to the binary image file')
    parser.add_argument('--idx_path', default='D:/Project/face/insightface-master/datasets/mingxing.idx', type=str,
                        help='path to the image index path')
    parser.add_argument('--tfrecords_file_path', default='D:/Project/face/insightface-master/datasets/', type=str,
