...
def get_args():
    ...
    parser.add_argument('--ckpt_file', default='./model/',
    ...
    parser.add_argument('--batch_size', default=1, help='batch size to train network')
    parser.add_argument('--ckpt_index_list',
                        default=['InsightFace_iter_20001.ckpt'], help='ckpt file indexes')
